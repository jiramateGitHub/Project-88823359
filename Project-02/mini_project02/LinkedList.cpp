...
void LinkedList::show() {
	...
	if(isEmpty()) {
		...
		for(node * temp = head; temp != NULL; temp = temp->link) {
			...
			cout << setw(0) << temp->stu.get_day() << "/" << temp->stu.get_month() << "/" << temp->stu.get_year();
			cout << "\t" <<temp->stu.get_day() << "/" << temp->stu.get_month() << "/" << temp->stu.get_year()+4;
			cout<<endl;
			i++;
		}
	}
...
void LinkedList::find(int id) {
	...
	for(node * temp = head; temp != NULL; temp = temp->link,i++) {
		if(temp->stu.get_id() == id) {
			...
			cout << setw(16) << left << temp->stu.get_firstname();
			cout << setw(16) << left << temp->stu.get_lastname();
			cout << setw(8) << left << temp->stu.get_faculty();
			cout << setw(16) << left << temp->stu.get_day() << "/" << temp->stu.get_month() << "/" << temp->stu.get_year();
			cout << setw(16) << left << temp->stu.get_day() << "/" << temp->stu.get_month() << "/" << temp->stu.get_year()+4;
			cout<<endl;
			break;
		}
